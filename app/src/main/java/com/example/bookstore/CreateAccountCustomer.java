...
public class CreateAccountCustomer extends AppCompatActivity {
    ...
    private EditText email,password,firstname,lastname,phno,address;
    private String semail,spassword,sfirstname,slastname,sphno,saddress,userid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createaccButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //saveData(semail,spassword,sfirstname,slastname,sphno,saddress);

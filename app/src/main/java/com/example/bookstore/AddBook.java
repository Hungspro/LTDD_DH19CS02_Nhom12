    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SellingBook sellingBook=new SellingBook(book_id,uniqueid,userid,
                        uq,up,urp,udp,book_title,book_author,book_desc,book_cat,image,preview);
                ...
                db.collection("SellingList").document(uniqueid).set(sellingBook).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        if(task.isSuccessful()) {
                            ...
                            Intent i =new Intent(AddBook.this, HomeAdmin.class);
                        } else{

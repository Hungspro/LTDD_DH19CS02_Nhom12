...
public class ViewOrderCustomer extends AppCompatActivity {
    ...
    TextView ssellerid,sstatus,sbookname,sorderon,sname,sphno,semail,saddress,stotalamount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_order_customer);
        ...
        docRef.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                if (documentSnapshot.exists()) {
                    ...
                    String oa = documentSnapshot.getString("orderdate");
        ...
        received.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FirebaseFirestore.getInstance().collection("Orders").document(orderid).update("updatedate",dateTime,"status",updateto).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
